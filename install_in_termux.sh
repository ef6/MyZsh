main() {
  ...
  CHECK_ZSH_INSTALLED=$(which zsh | grep /zsh | wc -l)
 ...
 printf "${BLUE}Using ef6's Oh My Zsh auto-update checks${NORMAL}\n"
  ...
  printf "${BLUE}Cloning Theme...${NORMAL}\n"
  env git clone --depth=1 https://github.com/denysdovhan/spaceship-prompt.git $ZSH/custom/themes/spaceship-prompt  || {
    printf "${RED}%s${NORMAL}\n" "Error: git clone of spaceship-prompt repo failed\n"
  }
